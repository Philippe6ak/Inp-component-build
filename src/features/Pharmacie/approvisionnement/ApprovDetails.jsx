...
function ApprovDetails({ approvisionnement }) {
  const lignes = approvisionnement.lignes ?? [];
    ...
    <div className="space-y-[1.6rem] w-[50rem]">
      <div>
        ...
        <p className="text-grey-600">
          <span className="font-medium">Libellé :</span> {approvisionnement.libelle}
        </p>
      </div>
...
ApprovDetails.propTypes = {
  approvisionnement: PropTypes.shape({
    approvisionnements_id: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
